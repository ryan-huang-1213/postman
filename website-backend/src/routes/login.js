const { RESET_PASSWORD_SECRET, REFRESH_TOKEN_SECRET, SALTROUNDS } = require("./../config");
...
const { FindAccountByEmail, UpdateAccountPassword, GetAccountStatus, FindAccountById } = require("../Modules/Database");
...
router.post("/refresh", AuthenticateRefreshToken, async (req, res) => {
	...
	const token = await GenerateAccessToken(AccountId, Account.Role, ip);
